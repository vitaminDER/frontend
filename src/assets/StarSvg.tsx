...
export const StarSvg = ({color}: StarSvgProps) => <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
...
<g>
    ...
    <path fill={color} d="M31.998,2.478c0.279,0,0.463,0.509,0.463,0.509l8.806,18.759l20.729,3.167l-14.999,15.38l3.541,21.701
